...
public class testing {
	...
	public static void main(String[] args) {
        ...
        System.out.println(image1.compareTo(image2));
        ...
        Meme meme4 = new Meme(image1, "captionimage1", user2);
        memes.add(meme4);
        feed.setMemes(memes);
        System.out.println(feed);
        feed.sortByCaption();
        ...
        for(int i = 0; i < feed.getMemes().size()-1; i++) {
            System.out.println(feed.getNewMeme(user3)); 
            user3.rateNextMemeFromFeed(feed, 1);
            System.out.println(user3.getMemesViewed());
        }
