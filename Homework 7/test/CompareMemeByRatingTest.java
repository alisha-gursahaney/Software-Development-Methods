...
// worked together with cohort (Sam, Rishab, and Yuna)
...
public class CompareMemeByRatingTest {
	...
	CompareMemeByRating creator = new CompareMemeByRating();
	
	Rating[] rat1 = new Rating[10];
	Rating[] rat2 = new Rating[10];
	Rating[] rat3 = {rating1, rating2, rating3, rating4, rating5, rating6, rating7, rating8, rating9, rating10};
	...
	public void compareTest() {
		...
		assertEquals(-1, creator.compare(meme2, meme6));
		assertEquals(0, creator.compare(meme2, meme9));
		assertEquals(-1, creator.compare(meme3, meme4));
		assertEquals(1, creator.compare(meme4, meme3));
		...
		new Meme(new BackgroundImage("image", "title", "description"),"caption", user2);
		new Rating(user1,1);

		new Meme(new BackgroundImage("image", "title", "description"),"caption", user3);
		new Rating(user1,1);
		
		new Meme(new BackgroundImage("image", "title", "description"),"caption", user4);
		new Rating(user1,1);
		
		new Meme(new BackgroundImage("image", "title", "description"),"caption", user5);
		new Rating(user1,-1);
		
		new Meme(new BackgroundImage("image", "title", "description"),"caption", user6);
		new Rating(user1,-1);

		new Meme(new BackgroundImage("image", "title", "description"),"caption", user7);
		new Rating(user1, 0);
		
		new Meme(new BackgroundImage("image", "title", "description"),"caption", user8);
		new Rating(user1,0);
		
		new Meme(new BackgroundImage("image", "title", "description"),"caption", user9);
		new Rating(user1,0);
